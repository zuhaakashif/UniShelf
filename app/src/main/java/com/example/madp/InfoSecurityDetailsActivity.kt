...
class InfoSecurityDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.rescs01)
        ...
        bookButton.setOnClickListener {
            val intent = Intent(this, INFO_book::class.java)
        ...
        pastPapersButton.setOnClickListener {
            val intent = Intent(this, INFO_past::class.java)
            startActivity(intent)
        }

        notesButton.setOnClickListener {
            val intent = Intent(this, INFO_notes::class.java)
            startActivity(intent)
        }
        backButton.setOnClickListener {
            val intent = Intent(this, sem08::class.java)
